  ...
  const projectsData = [
    {
      ...
      content:
        "Complete redevelopment of Mathura's iconic park with modern amenities while preserving its cultural significance.",
    ...
    },
    {
      ...
      content:
        "Heritage conservation project preserving this important historical monument using traditional techniques.",
    ...
    },
    {
      ...
      content:
        "Sustainable residential development incorporating smart city principles and green building technologies.",
      ...
      >
        <div className="">
          ...
          <p className="text-gray-600 text-lg font-light mt-4 max-w-md">
            A showcase of our architectural excellence and innovative design
            solutions
          </p>
        </div>
      </motion.div>
            ...
            shownitem && (
              ...
              >
                ...
                >
                  ...
                  {/* View Project Button */}
                  <motion.div className="absolute bottom-6 right-6 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                ...
                >
                  ...
                  >
                    <h4 className="text-sm font-light text-gray-500 uppercase tracking-wider">
                      Key Features
                    </h4>
                    <div className="space-y-3">
                      {project.features.map((feature, featureIndex) => (
                        <div
                          key={featureIndex}
                          className="flex items-center gap-4 text-gray-700 group/feature"
                        >
