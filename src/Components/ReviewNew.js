            ...
            <div className='w-[100%] lg:w-[50%] m-auto h-[50%] '>
                ...
                <div className='w-[75%] md:w-[90%] lg:w-[75%] m-auto  h-[200px] flex align-center md:h-[50%] lg:h-[200px] '>
                    <Swiper ref={swiperRef} onSwiper={(swiper) => {
                        ...
                        <SwiperSlide>            <p style={{lineHeight:"150%    "}} className='text-center text-[1.1rem] italic mx-auto text-[#c1d0d8]  md:text-[3.5rem] lg:text-[1.1rem]'>
                        ...
                        <SwiperSlide>            <p className='text-center text-[1.1rem] italic mx-auto text-[#c1d0d8] md:text-[3.5rem] lg:text-[1.1rem]'>
